...
local menuGM_Civ_FR_A380_START = "START A-380 Sydney-Paris"
menuGM_Civ_FR_A380_DIVERT = "DIVERT French A-380 Sydney > Paris"
...
local MenuGM = MENU_COALITION:New(coalition.side.BLUE, "Game Master")
  ...
  local MenuGMAir = MENU_COALITION:New(coalition.side.BLUE, "Air Traffic", MenuGM)
    menuCommands[menuGM_Civ_FR_A380_START] = MENU_COALITION_COMMAND:New(coalition.side.BLUE, menuGM_Civ_FR_A380_START, MenuGMAir, SetFlag, "civ_fr_a380_start", true, menuGM_Civ_FR_A380_START)
    menuCommands[menuGM_Civ_FR_A380_DIVERT] = MENU_COALITION_COMMAND:New(coalition.side.BLUE, menuGM_Civ_FR_A380_DIVERT, MenuGMAir, SetFlag, "civ_fr_a380_divert", true, menuGM_Civ_FR_A380_DIVERT)
